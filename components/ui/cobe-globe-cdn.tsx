...
export function GlobeCdn({
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      // #533AFC = rgb(83, 58, 252) → normalized: [0.325, 0.227, 0.988]
  ...
  const pyramidFaceStyle = (nth: number): React.CSSProperties => {
    ...
    // Purple shades matching #533AFC
    const colors = ["#533AFC", "#6B52FC", "#8470FD", "#4A32E0"]
    return {
      position: "absolute",
      left: -0.5,
      top: 0,
        ...
        >
          ...
          <span
            style={{
              ...
              boxShadow: "0 1px 3px rgba(83,58,252,0.15)",
            }}
          >
            {m.region}
          </span>
