...
const ImageGrid1: React.FC<ImageGridProps> = ({ smallImage, halfImage, largeImage, tallImage }) => {
  return (
    <div className="grid grid-cols-4 grid-rows-3 gap-4 max-w-5xl mx-auto
      ...
      <motion.div 
        className="col-span-1 row-span-1 col-start-1 row-start-1 overflow-hidden rounded-3xl"
      ...
      <motion.div 
        className="col-span-1 row-span-2 col-start-1 row-start-2 overflow-hidden rounded-3xl"
        initial={{ opacity: 0, y: 20 }} 
        whileInView={{ opacity: 1, y: 0 }} 
      ...
      <motion.div 
        className="col-span-2 row-span-2 col-start-2 row-start-1 overflow-hidden rounded-3xl"
        initial={{ opacity: 0, y: 20 }} 
        whileInView={{ opacity: 1, y: 0 }} 
        transition={{ duration: 0.6, ease: "easeOut", delay: 0.2 }}
        viewport={{ once: true }}
