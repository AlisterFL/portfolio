        ...
        <div className="w-full px-4">
          {translations.education_list.map((education, index) => (
            <motion.div
              ...
              className="flex items-center justify-between p-4 border-b border-t border-gray-700 text-white transition-colors duration-300 hover:bg-white hover:text-black">
              ...
              <h3 className="text-lg font-light w-2/4">{education.title}</h3>
            </motion.div>
          ))}
        </div>
    </section>
