  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        {/* Social links */}
        <a href="https://www.instagram.com/kosmosieper/" target="_blank" rel="noopener noreferrer" className="text-[#1a1a1a]/40 transition-colors hover:text-[#d4af37]">
        ...
        <a href="https://www.facebook.com/kosmosieper" target="_blank" rel="noopener noreferrer" className="text-[#1a1a1a]/40 transition-colors hover:text-[#d4af37]">
          <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
