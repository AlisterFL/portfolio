...
const t = {
  ...
  heading: { fr: "Tapas, cocktails\net bonne ambiance.", nl: "Tapas, cocktails\nen goede sfeer.", en: "Tapas, cocktails\nand good vibes.", de: "Tapas, Cocktails\nund gute Stimmung." },
    ...
    >
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-16 lg:grid-cols-2">
        ...
        <div ref={textRef} className="opacity-0">
          {/* Section label */}
          <p className="mb-5 text-[11px] font-medium tracking-[0.3em] uppercase text-[#d4af37]">
            {t.sectionLabel[language]}
          </p>

          {/* Heading */}
          <h2 className="font-[family-name:var(--font-playfair)] text-4xl font-bold leading-[1.15] text-[#1a1a1a] md:text-5xl whitespace-pre-line">
            {t.heading[language]}
          </h2>
          ...
          <div className="mt-8 flex items-center gap-5">
            ...
            {/* TripAdvisor */}
            <div className="flex items-center gap-2">
              <svg viewBox="0 0 72 72" className="h-4 w-4 shrink-0" aria-hidden="true">
                <path fill="#34E0A1" d="M72,36c0,19.9-16.1,36-36,36S0,55.9,0,36C0,16.1,16.1,0,36,0S72,16.1,72,36" />
                <path fill="#000" d="M58.2,28.9l4.3-4.7h-9.6C48.1,20.9,42.3,19,36,19c-6.3,0-12.1,1.9-16.9,5.2H9.5l4.3,4.7c-2.7,2.4-4.3,5.9-4.3,9.8c0,7.3,5.9,13.2,13.2,13.2c3.5,0,6.6-1.3,9-3.5L36,53l4.2-4.6c2.4,2.2,5.5,3.5,9,3.5c7.3,0,13.2-5.9,13.2-13.2C62.5,34.8,60.8,31.3,58.2,28.9 M22.8,47.6c-5,0-9-4-9-9c0-5,4-9,9-9s9,4,9,9C31.7,43.6,27.7,47.6,22.8,47.6 M36,38.4c0-5.9-4.3-11-9.9-13.1c3.1-1.3,6.4-2,9.9-2c3.5,0,6.9,0.7,9.9,2C40.3,27.5,36,32.5,36,38.4 M49.2,47.6c-5,0-9-4-9-9c0-5,4-9,9-9s9,4,9,9C58.2,43.6,54.2,47.6,49.2,47.6 M49.2,34c-2.6,0-4.7,2.1-4.7,4.7c0,2.6,2.1,4.7,4.7,4.7s4.7-2.1,4.7-4.7C53.9,36.1,51.8,34,49.2,34 M27.5,38.7c0,2.6-2.1,4.7-4.7,4.7c-2.6,0-4.7-2.1-4.7-4.7c0-2.6,2.1-4.7,4.7-4.7C25.4,34,27.5,36.1,27.5,38.7" />
              </svg>
              <span className="text-sm font-medium text-[#1a1a1a]/60">4.6</span>
